...
我是一名计算机科学与技术本科生，也是一名开源爱好者。

我喜欢构建能解决实际问题的 AI 工具，关注如何把大模型能力应用到真实任务流程中，
让复杂的事情变得可用、可复用、可持续迭代。

我在探索知识的结构化表达，也在实践 AI Agent 与 AI Skill 的落地应用，
同时关注如何将静态内容（如 PPT）转化为真正可编辑和可复用的格式，
以及如何通过多画布的方式释放 AI 在创作领域的生产力。

---

## 🎯 目前主要关注的方向

| 🕸️ 知识图谱与图谱增强问答 | 🤖 AI Agent 与 AI Skill 开发 | 📄 PPT 可编辑化重建 | 🎨 多画布 AI 创作工具 |
| :--- | :--- | :--- | :--- |
| 关注知识图谱构建、实体关系组织、语义检索与图谱增强问答。 | 围绕具体任务封装提示词、工具调用与执行流程，打造可复用的 AI Skill 和智能体。 | 将截图式、图片式或扫描版 PPT 重建为真正可编辑的 PowerPoint 文件。 | 从自然语言需求到可视化结果生成，支持流程图、PPT、海报、信息图等多类型内容创作。 |
